...
def depthFirstSearch(problem):
    ...
    while not fringe.isEmpty():
        ...
        if curr not in node_expanded:
            ...
            for position, direction, f_value_per_move in problem.getSuccessors(curr):
...
def uniformCostSearch(problem):
    ...
    while not fringe.isEmpty():
        ...
        if curr not in node_expanded:
            ...
            for position, direction, f_value_per_move in problem.getSuccessors(curr):
                moves_priority_queue.push(moves + [direction],
                                          problem.getCostOfActions(moves) + f_value_per_move)
                fringe.push(position,
                            problem.getCostOfActions(moves) + f_value_per_move)
    #util.raiseNotDefined()
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    while not fringe.isEmpty():
        ...
        if curr not in node_expanded:
            ...
            for position, direction, f_value_per_move in problem.getSuccessors(curr):
                moves_priority_queue.push(moves + [direction],
                                          problem.getCostOfActions(moves) + f_value_per_move + heuristic(position,
                                                                                                         problem))

                fringe.push(position,
                            problem.getCostOfActions(moves) + f_value_per_move + heuristic(position, problem))
    #util.raiseNotDefined()
